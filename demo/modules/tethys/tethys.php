...
class modul_tethys extends module{
	...
	function get_menu($page_id){
		...
		new menu_topic($menu,"tethys_modules",$page_id,"Modules","http://tethys-framework.de/t/modules/tethys_shared/module.html",true);
		new menu_topic($menu,"tethys_skins",$page_id,"Skins","http://tethys-framework.de/t/modules/tethys_shared/skins.html",true);
		return $menu;
	}
